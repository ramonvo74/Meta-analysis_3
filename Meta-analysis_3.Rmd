...
```{r, out.width = "600px", echo=FALSE, fig.align='center'}
knitr::include_graphics("study_3.png") # Borenstein et al. 2009:70
```
...
knitr::include_graphics("https://media.giphy.com/media/3qQ329Rgle89i/giphy.gif") # from giphy.com
```
...
```{r, fig.width=10,fig.height=7.3, dev='svg'}
forest(model_hksj)
```
...
```{r,out.width = "500px", echo=F, dev='svg',fig.align='center'}
forest(model_hksj,
       sortvar=TE,
       xlim = c(-0.5,2.5),
       rightlabs = c("g","95% CI","weight"),
...
```{r, out.width = "600px", echo=FALSE, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/oShObTfbg3S5G/giphy.gif") # from giphy.com
```
